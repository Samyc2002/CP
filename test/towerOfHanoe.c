...
void TowerOfHanoe(int num_of_disks, struct Stack *src, struct Stack *aux, struct Stack *dest) {
    ...
    for (i = num_of_disks; i >= 1; i--) push(src, i);       //Larger disks will be pushed first
